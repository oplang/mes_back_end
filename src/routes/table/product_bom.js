...
router.prefix('/api/product_bom')

router.get('/list', async (ctx, next) => {
  const data = await get('product_bom', ctx.query);
...
router.delete('/del', async (ctx) => {
  ...
  const result = await del('product_bom', 'bom_code', id);
