...
router.prefix('/api/wip_lot_history')

router.get('/list', async (ctx, next) => {
  const data = await get('wip_lot_history', ctx.query);
...
router.delete('/del', async (ctx) => {
  ...
  const result = await del('wip_lot_history', 'w_lot_timekey', id);
